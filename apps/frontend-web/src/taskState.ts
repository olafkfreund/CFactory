 ...
 *
 *  Exported because the Running-tasks view needs the same definition. It used
 *  to spell "active" as `overall !== "done"`, which counted failed work as
 *  active and showed every failure under both Active and Failed. */
