...
7 findings with the plural form and 0 with the singular one.

It stayed invisible for the usual reason -- neither observer could see it. The
PR job only fails when a diff happens to touch an allowlisted path, which is
rare, and a scheduled full-history job has no PR to turn red. Same defect and
same fix as AIFactory#1343.
